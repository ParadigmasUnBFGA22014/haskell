module Grafo(grafo,retorna_no,filtra_alternativas_no,ver_alternativas_no,ver_informacao_no,selec_sec)where
...
--usar isso para explicar grafo na sala 
--grafo = [
--		([(1,4,"(1) Valparaiso"),(1,5,"(2) Gama"),(1,2,"(3) Taguatinga"),(1,3,"(4) Ocidental")],1,"Para onde vc quer ir?"),
--		([(2,1,"(1) Rodoviaria"),(2,3,"(2) Cidade Ocidental")],2,"Para onde vc quer ir?"),
--		([(3,1,"(1) Rodoviaria"),(3,4,"(2) Valparaiso")],3,"Para onde vc quer ir ?"),
--		([(4,1,"(1) Rodoviaria"),(4,5,"(2) Gama")],4,"Para onde vc quer ir?"),
--		([(5,1,"(1) Rodoviaria"),(5,2,"(2) Taguatinga")],5,"Para onde vc quer ir?")
...
grafo = [
		...
		([(4,5,"(1) Esperar outro onibus"), (4,11,"(2) Chamar um moto taxi")], 4, "Cara, voce e um universitario, voce nao tem dinheiro nem para comer. Como voce passou no vestibular pensando assim?"),
		...
		([(8,44,"(1) Ir para FGA!")], 8, "Boa opcao. apesar dos inumeros problemas voce conseguiu chegar na FGA a tempo!"),
		([(9,8,"(1) Pegar o Integracao"), (9,10,"(2) Ir a pe")], 9, "O onibus estava saindo e o motorista nao parou para voce. Tente outra maneira."),
		([(10,0,"Game Over!  Digite 1 para reiniciar.")], 10, "Voce desmaiou na metade do caminho por ser sedentario."),
		([(11,12,"(1) Descer e sair correndo"), (11,13,"(2) Explicar a Situacao")], 11, "Opa! Esta tendo uma blitz na entrada do gama e voce sabe que os documentos do veiculo estao vencidos."),
		...
		--No 14?
		([(15,11,"(1) Chamar um moto taxi"), (15,11,"(2) Esperar")], 15, "Mais uma mare de sorte. Houve um acidente e esta tudo parado."),
		...
		([(19,27,"(1) Dar Lugar, e ir para o fundo do onibus"), (19,28,"(2) Fingir estar dormindo")], 19,"Voce conseguiu pegar um onibus meio vazio e sentar nas cadeiras preferenciais, porem entra uma velhinha!"),
		...
		([(25,20,"(1) Ir Preso!")], 25,"Que mancada! O policial ficou furioso e te prendeu por tentativa de suborno!"),
		([(26,20,"(1) Voltar pra casa")], 26,"Voce estava andando e foi assaltado, levaram tudo!"),
		([(27,29,"(1) Continuar no onibus"), (27,20,"(2) Descer do onibus")], 27,"O onibus foi assaltado e levaram todo dinheiro e pertences de que estava nas cadeiras preferenciais, voce escapou!"),
		([(28,31,"(1) Continuar no onibus"),(28,26,"(2) Descer do onibus")], 28,"O onibus foi assaltado e roubaram todos que estavam nas cadeiras preferenciais, levaram ate seus tenis!"),
		([(29,30,"(1) Esperar proximo"),(29,10,"(2) Ir andando")], 29,"O onibus quebrou faltando apenas 5km para a FGA!"),
		([(30,44,"(1) Entrar na FGA")], 30,"O proximo onibus demorou 1h, mas como voce e preparado saiu cedo de casa e conseguiu chegar na FGA!"),
...
filtra_alternativas_no :: No -> [(Aresta,Aresta,Alternativa)]
filtra_alternativas_no x = selec_prim x

ver_alternativas_no :: [(Aresta,Aresta,Alternativa)] -> [Alternativa]
ver_alternativas_no [] = []
ver_alternativas_no ((arestaA,arestaB,alternativa):xs) = alternativa:(ver_alternativas_no xs)
