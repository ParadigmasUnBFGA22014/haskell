...
grafo = [
		...
		([(19,27,"(1) Dar Lugar, e ir para o fundo do onibus"), (19,28,"(2) Fingir estar dormindo")], 19,"Voce consegue pegar um onibus meio vazio e sentar nas cadeiras preferenciais, porem entra uma velhinha!"),
